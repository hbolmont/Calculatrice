...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = calculatrice1.0.0
DISTDIR = /home/nicolas/Documents/GitHub/Calculatrice/.tmp/calculatrice1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		qmake.pro fenetre.hpp main.cpp \
		fenetre.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents fenetre.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp fenetre.cpp $(DISTDIR)/
